  ...
  return (
    <div className="header">
      ...
      <div className="navigation-small-screen">
        <GiHamburgerMenu
          className="navigation-small-screen__open-button"
          onClick={openMenu}
        />
        {turnMenu && (
          <div
            className="navigation-small-screen__overlay slide-bottom"
            onClick={closeMenu}
          >
            <MdRestaurantMenu className="navigation-small-screen__close-button" />
            <ul className="navigation-small-screen__menu">
              <li className="navigation-small-screen__item">
                <a
                  href="#home"
                  className="link navigation-small-screen__link link_letter_04"
                >
                  {' '}
                  Home{' '}
                </a>{' '}
