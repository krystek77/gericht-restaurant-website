    ...
    <div className='hero'>
      <div className='hero__inner'>
        <div className='hero__info'>
          ...
          <Title purpose='page' classes='title_header-h1 mr_bottom-2' content='The Key To Fine Dining' />
          <Description>Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus</Description>
