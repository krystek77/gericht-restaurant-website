    ...
    <div className='footer'>
      ...
      <div className='footer__content'>
        <div className='footer__contact'>
          ...
          <p className='footer__contact-address'>9 W 53rd St, New York, NY 10019, USA</p>
          <p className='footer__contact-phone'>+1 212-344-1230</p>
          <p className='footer__contact-phone'>+1 212-555-1230</p>
        </div>
        <div className='footer__social-media'>
          <img className='footer__social-media-logo' src={images.GerichtLogoSVG} alt='Gericht Logo' />
          <p className="footer__social-media-info">"The best way to find yourself is to lose yourself in the service of others.”</p>
          <Spoon/>
          <div className="footer__social-media-icons">
            <img className="footer__social-media-facebook" src={images.facebook} alt="facebook" />
            <img className="footer__social-media-twitter" src={images.twitter} alt="twitter" />
            <img className="footer__social-media-instagram" src={images.instagram} alt="instagram" />
          </div>
        </div>
